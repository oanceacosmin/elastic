     ...
     <div class="col"> 
            ...
            <?php   //Populate Dashboard with news results
                    ...
                    if(isset($_GET['searchButton'])){
                        $search = $_GET['Search'];
                        $sql = "SELECT * FROM incidposts WHERE postTitle LIKE '%$search%' or postDesc LIKE '%$search%' ";
                    } else {
                        $approved = "Yes";
                        $incIdFromUrl = $_GET['id'];
                        $userType = $_SESSION['userType'];
                        if($userType == 'normal'){
                        $sql = "SELECT * FROM incidposts WHERE incID='$incIdFromUrl' AND approved = '$approved'";}
                        else{
                         $sql = "SELECT * FROM incidposts WHERE incID='$incIdFromUrl'";}                           
                        }
